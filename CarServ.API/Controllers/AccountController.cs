...
namespace CarServ.API.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateStaffAccount([FromBody] StaffDTO dto)
        {
            ...
            {
                int roleID = 0;
                if (dto.RoleName.Equals("ServiceStaff") || dto.RoleName.Equals("Nhân viên dịch vụ")) roleID = 3;
                if (dto.RoleName.Equals("InventoryManager") || dto.RoleName.Equals("Nhân viên quản lý kho")) roleID = 4;
                var staff = await _accService.AddingNewStaff(dto.FullName, dto.Email, dto.PhoneNumber, dto.Password, dto.Address, roleID);
