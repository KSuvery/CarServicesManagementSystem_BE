...
public partial class CarServicesManagementSystemContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AppointmentId).HasName("PK__Appointm__8ECDFCA25B0E001E");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.Appointments)
                ...
                .HasConstraintName("FK__Appointme__Custo__6C190EBB");

            entity.HasOne(d => d.Package).WithMany(p => p.Appointments)
                .HasForeignKey(d => d.PackageId)
                .HasConstraintName("FK__Appointme__Packa__6D0D32F4");

            entity.HasOne(d => d.Promotion).WithMany(p => p.Appointments)
                .HasForeignKey(d => d.PromotionId)
                .HasConstraintName("FK__Appointme__Promo__6E01572D");
        });

        modelBuilder.Entity<AppointmentService>(entity =>
        {
            entity.HasKey(e => new { e.AppointmentId, e.ServiceId }).HasName("PK__Appointm__329C47AC256E7E3C");
        ...
        {
            entity.HasKey(e => e.CarTypeId).HasName("PK__CarTypes__2B2E84BD3F1AB4CB");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B8F9FA4BD2");
        ...
        {
            entity.HasKey(e => e.ManagerId).HasName("PK__Inventor__3BA2AA81F77207F7");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E328AF3691E");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BAF4107370C");

            entity.HasIndex(e => e.AppointmentId, "UQ__Orders__8ECDFCA337B88901").IsUnique();
            ...
            entity.HasOne(d => d.Appointment).WithOne(p => p.Order)
                ...
                .HasConstraintName("FK__Orders__Appointm__75A278F5");

            entity.HasOne(d => d.Promotion).WithMany(p => p.Orders)
                .HasForeignKey(d => d.PromotionId)
                .HasConstraintName("FK__Orders__Promotio__76969D2E");
        });

        modelBuilder.Entity<OrderDetail>(entity =>
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D30CC4A9E6D7");
        ...
        {
            entity.HasKey(e => e.PartId).HasName("PK__Parts__7C3F0D3043142D49");
        ...
        {
            entity.HasKey(e => e.PriceId).HasName("PK__PartPric__4957584FF94DC27A");
            ...
            entity.HasOne(d => d.Part).WithMany(p => p.PartPrices)
                ...
                .HasConstraintName("FK__PartPrice__PartI__797309D9");
        });

        modelBuilder.Entity<Payment>(entity =>
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payments__9B556A583A3F2C94");
            ...
            entity.HasOne(d => d.Appointment).WithMany(p => p.Payments)
                .HasForeignKey(d => d.AppointmentId)
                .HasConstraintName("FK__Payments__Appoin__7A672E12");
        ...
        {
            entity.HasKey(e => e.PromotionId).HasName("PK__Promotio__52C42F2F6B59AA80");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE3ADD47D442");
        ...
        {
            entity.HasKey(e => e.ServiceId).HasName("PK__ServiceH__C51BB0EA361AE1C8");
            ...
            entity.HasOne(d => d.Service).WithOne(p => p.ServiceHistory)
                ...
                .HasConstraintName("FK__ServiceHi__Servi__7C4F7684");

            entity.HasOne(d => d.Staff).WithMany(p => p.ServiceHistories)
                .HasForeignKey(d => d.StaffId)
                .HasConstraintName("FK__ServiceHi__Staff__7D439ABD");
        });

        modelBuilder.Entity<ServicePackage>(entity =>
        {
            entity.HasKey(e => e.PackageId).HasName("PK__ServiceP__322035ECAF8EDE3E");
            ...
            entity.HasMany(d => d.Services).WithMany(p => p.Packages)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    l => l.HasOne<ServicePackage>().WithMany()
                        ...
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__PackageSe__Packa__778AC167"),
                    j =>
                    {
                        j.HasKey("PackageId", "ServiceId").HasName("PK__PackageS__8E718EE248144874");
        ...
        {
            entity.HasKey(e => new { e.ServiceId, e.PartId }).HasName("PK__ServiceP__D2D840395B5A6236");
            ...
            entity.HasOne(d => d.Part).WithMany(p => p.ServiceParts)
                .HasForeignKey(d => d.PartId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ServicePa__PartI__7E37BEF6");
        ...
        {
            entity.HasKey(e => e.ProgressId).HasName("PK__ServiceP__BAE29C85D3377D2E");
            ...
            entity.HasOne(d => d.Appointment).WithMany(p => p.ServiceProgresses)
                .HasForeignKey(d => d.AppointmentId)
                .HasConstraintName("FK__ServicePr__Appoi__00200768");
        });

        modelBuilder.Entity<ServiceStaff>(entity =>
        {
            entity.HasKey(e => e.StaffId).HasName("PK__ServiceS__96D4AAF7C07529DE");
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE66694DCE5D038");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCACDC92D2F8");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D10534FE39B59E").IsUnique();
            ...
            entity.HasOne(d => d.Role).WithMany(p => p.Users)
                ...
                .HasConstraintName("FK__Users__RoleID__02084FDA");
        });

        modelBuilder.Entity<Vehicle>(entity =>
        {
            entity.HasKey(e => e.VehicleId).HasName("PK__Vehicles__476B54B27E6353F9");
            ...
            entity.HasOne(d => d.CarType).WithMany(p => p.Vehicles)
                ...
                .HasConstraintName("FK__Vehicles__CarTyp__02FC7413");

            entity.HasOne(d => d.Customer).WithMany(p => p.Vehicles)
                .HasForeignKey(d => d.CustomerId)
                .HasConstraintName("FK__Vehicles__Custom__03F0984C");
        });

        modelBuilder.Entity<WarrantyClaim>(entity =>
        {
            entity.HasKey(e => e.ClaimId).HasName("PK__Warranty__EF2E13BBDBC85602");
            ...
            entity.HasOne(d => d.Part).WithMany(p => p.WarrantyClaims)
                .HasForeignKey(d => d.PartId)
                .HasConstraintName("FK__WarrantyC__PartI__04E4BC85");

            entity.HasOne(d => d.Supplier).WithMany(p => p.WarrantyClaims)
                .HasForeignKey(d => d.SupplierId)
                .HasConstraintName("FK__WarrantyC__Suppl__05D8E0BE");
        });
